...
class Solver {
	...
	public static readonly sbyte LOWER_BOUND = 0;
	public static readonly sbyte UPPER_BOUND = 1;
	public static readonly sbyte FREE = 2;
	...
	public void swap_index(int i, int j)
	{
		...
		do {sbyte _=alpha_status[i]; alpha_status[i]=alpha_status[j]; alpha_status[j]=_;} while(false);
	...
	public virtual int select_working_set(int[] working_set)
	{
	...
	public virtual void do_shrinking()
	{
		int i;
	...
	public virtual double calculate_rho()
	{
		double r;
		int nr_free = 0;
...
class Solver_NU : Solver
{
	...
	// return 1 if already optimal, return 0 otherwise
	public override int select_working_set(int[] working_set)
	{
	...
	public override void do_shrinking()
	{
	...
	public override double calculate_rho()
	{
